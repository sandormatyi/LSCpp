    ...
    while (std::getline(inputFile, line)) {
        ...
        if (command == "#") {
            ...
            if (command == "zoom") {
                ...
                std::string param;
                std::getline(stringStream, param);
                fractal_value_t amount = atof(param.c_str());
            ...
            if (command == "zoom") {
                ...
                bool enable;
                stringStream >> enable;
                commandData.beats[beatIndex].commands.push_back(new SetSaveImageCommand(enable ? _scoreData.folderName : ""));
            ...
            if (command == "zoom") {
                ...
                std::getline(stringStream, param);
                fractal_value_t amount = atof(param.c_str());
                fractal_value_t scaledAmount = amount / framesPerBeat;
